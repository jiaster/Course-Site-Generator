package coursesitegenerator.dialogs;
...
public class TADialog extends Stage {
    ...
    public TADialog(CourseSiteGenerator initApp) {
    ...
    private void initDialog() {
        ...
        guiBuilder.buildLabel(CSG_TA_DIALOG_HEADER_LABEL, gridPane, 0, 0, 3, 1, CLASS_CSG_DIALOG_HEADER, ENABLED);
        guiBuilder.buildLabel(CSG_TA_DIALOG_NAME_LABEL, gridPane, 0, 1, 1, 1, CLASS_CSG_DIALOG_PROMPT, ENABLED);
        ...
        RadioButton gradRadioButton = guiBuilder.buildRadioButton(CSG_TA_DIALOG_GRAD_RADIO_BUTTON, gridPane, 1, 3, 1, 1, CLASS_CSG_DIALOG_RADIO_BUTTON, ENABLED, tg, true);
        RadioButton undergradRadioButton = guiBuilder.buildRadioButton(CSG_TA_DIALOG_UNDERGRAD_RADIO_BUTTON, gridPane, 2, 3, 1, 1, CLASS_CSG_DIALOG_RADIO_BUTTON, ENABLED, tg, false);
